 ...
 * Body (FormData): { code: string, phone: string }
 *
 * Verifies the submitted OTP via MSG91 for the authenticated user and,
 * on success, marks their profile phone as verified.
 *
